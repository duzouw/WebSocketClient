...
import cn.duzou.netty.client.P6eWebsocketClientApplication;
...
public abstract class P6eChannelAbstract {
     ...
     * 全局只有一个这样的对象
     */
    protected static P6eWebsocketClientApplication clientApplication = P6eWebsocketClientApplication.run(P6eNioModel.class);
