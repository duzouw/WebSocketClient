...
import cn.duzou.channel.blibli.P6eBliBliChannel;
...
//        P6eLoggerCommon.init();
        ...
        /* 斗鱼连接弹幕房间 */
        P6eDouYuChannel p6eDouYuChannel = P6eDouYuChannel.create("99999", messages -> {
            for (P6eDouYuChannelMessage message : messages) {
                log.info("[ DOU YU ] ==> " + message.data().toString());
            }
        });

        /* BliBli 连接弹幕房间 */
//        P6eBliBliChannel p6eBliBliChannel = P6eBliBliChannel.create("388", messages -> {
